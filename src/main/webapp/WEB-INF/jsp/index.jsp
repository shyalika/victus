...
<style>
  .speech {border: 1px solid #DDD; width: 395px; padding: 0; margin: 0}
  .speech input {border: 0; width: 350px; display: inline-block; height: 40px;}
            ...
            <form
                ...
                <div class="speech">
                    <input
                        ...
                        name="q"
                        id="transcript"
                        placeholder="Talk to Victus" /> <img
            ...
            <div class="row">
                <article class="col-6 col-12-xsmall work-item">
                    <a
                        ...
                        alt="" /></a>
                    <h3>Seared tuna and anchovy runner beans</h3>
                    <p>The perfect lunch or light dinner, this healthy seared tuna and runner bean dish packs in nutrients and tastes great.</p>
                </article>
                <article class="col-6 col-12-xsmall work-item">
                    <a
                        ...
                        alt="" /></a>
                    <h3>Creamy ham and mushroom pasta bake</h3>
                    <p>Use up the leftovers in your fridge with this hearty family supper dish.</p>
                </article>
                <article class="col-6 col-12-xsmall work-item">
                    <a
                ...
                <article class="col-6 col-12-xsmall work-item">
                    <a
                        ...
                        alt="" /></a>
                    <h3>Sticky chilli roast chicken</h3>
                    <p>These sticky chicken pieces with salsa and salad are perfect for easy yet glamorous entertaining.</p>
                </article>
                <article class="col-6 col-12-xsmall work-item">
                    <a
  ...
  <!-- 
        <section id="three">
            ...
            <p>Accumsan pellentesque commodo blandit enim arcu non at amet id arcu magna.
                Accumsan orci faucibus id eu lorem semper nunc nisi lorem vulputate lorem neque
                lorem ipsum dolor.</p>
            <div class="row">
